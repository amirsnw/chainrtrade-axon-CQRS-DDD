...
public interface ProductMapper {
    ...
    ProductReservationReleasedEvent toEvent(ReleaseProductCommand command);

    ProductReservationConfirmedEvent toEvent(ConfirmProductReservationCommand command);
